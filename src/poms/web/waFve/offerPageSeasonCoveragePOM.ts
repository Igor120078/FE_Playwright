...
export class OfferPageSeasonCoveragePOM extends POM {
  ...
  private sufficiencyCoverage: LabelInterface
  ...
  private sufficiencyWinterCoverageValue: LabelInterface
  private sufficiencySpringCoverageValue: LabelInterface
  private sufficiencySummerCoverageValue: LabelInterface
  private sufficiencyAutumnCoverageValue: LabelInterface
  ...
  constructor(page: Page) {
    ...
    this.optimumCoverage = ComponentFactory.createLabel()
      ...
      .setVisible(true)
    this.sufficiencyCoverage = ComponentFactory.createLabel()
      .label()
      .setLocator(this.page.getByText('FVE_OFFER_TYPE.SELF_SUFFICIENCY', { exact: true }).nth(0))
      .setVisible(true)
    ...
    this.sufficiencyWinterCoverageValue = ComponentFactory.createLabel()
      .label()
      .setLocator(this.page.locator("(//div[text()='FVE_OFFER_TYPE.SELF_SUFFICIENCY']/following-sibling::div)[1]"))
      .setVisible(true)
    this.sufficiencySpringCoverageValue = ComponentFactory.createLabel()
      .label()
      .setLocator(this.page.locator("(//div[text()='FVE_OFFER_TYPE.SELF_SUFFICIENCY']/following-sibling::div)[2]"))
      .setVisible(true)
    this.sufficiencySummerCoverageValue = ComponentFactory.createLabel()
      .label()
      .setLocator(this.page.locator("(//div[text()='FVE_OFFER_TYPE.SELF_SUFFICIENCY']/following-sibling::div)[3]"))
      .setVisible(true)
    this.sufficiencyAutumnCoverageValue = ComponentFactory.createLabel()
      .label()
      .setLocator(this.page.locator("(//div[text()='FVE_OFFER_TYPE.SELF_SUFFICIENCY']/following-sibling::div)[4]"))
      .setVisible(true)
  ...
  async validateAllComponents(): Promise<void> {
    ...
    await this.sufficiencyCoverage.validateSelf()
    ...
    await this.sufficiencyWinterCoverageValue.validateSelf()
    await this.sufficiencySpringCoverageValue.validateSelf()
    await this.sufficiencySummerCoverageValue.validateSelf()
    await this.sufficiencyAutumnCoverageValue.validateSelf()
  ...
  async validateSeasonCoverageValues() {
    ...
    let sufficiencyWinter = Number((await this.sufficiencyWinterCoverageValue.readElementText()).replace(/\D+/g, ''))
    console.log(`Sufficiency Winter coverage: ${sufficiencyWinter}%`)
    expect(sufficiencyWinter).toBeGreaterThan(1)
    let sufficiencySpring = Number((await this.sufficiencySpringCoverageValue.readElementText()).replace(/\D+/g, ''))
    console.log(`Sufficiency Spring coverage: ${sufficiencySpring}%`)
    expect(sufficiencySpring).toBeGreaterThan(1)
    let sufficiencySummer = Number((await this.sufficiencySummerCoverageValue.readElementText()).replace(/\D+/g, ''))
    console.log(`Sufficiency Summer coverage: ${sufficiencySummer}%`)
    expect(sufficiencySummer).toBeGreaterThan(1)
    let sufficiencyAutumn = Number((await this.sufficiencyAutumnCoverageValue.readElementText()).replace(/\D+/g, ''))
    console.log(`Sufficiency Autumn coverage: ${sufficiencyAutumn}%`)
    expect(sufficiencyAutumn).toBeGreaterThan(1)
  }
}
