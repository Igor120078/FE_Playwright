...
export class OfferPageFutureEnergyPaymentsPOM extends POM {
  ...
  private futurePaymentsSufficiency: LabelInterface
  ...
  constructor(page: Page) {
    ...
    this.futurePaymentsOptimum = ComponentFactory.createLabel()
      ...
      .setVisible(true)
    this.futurePaymentsSufficiency = ComponentFactory.createLabel()
      .label()
      .setLocator(this.page.getByText('FVE_OFFER_TYPE.SELF_SUFFICIENCY', { exact: true }).nth(2))
      .setVisible(true)
  ...
  async validateAllComponents(): Promise<void> {
    ...
    await this.futurePaymentsSufficiency.validateSelf()
