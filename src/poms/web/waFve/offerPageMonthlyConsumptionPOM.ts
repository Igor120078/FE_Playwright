...
export class OfferPageMonthlyConsumptionPOM extends POM {
  ...
  private monthlyConsumptionSufficiency: LabelInterface
  ...
  constructor(page: Page) {
    ...
    this.monthlyConsumptionOptimum = ComponentFactory.createLabel()
      ...
      .setVisible(true)
    this.monthlyConsumptionSufficiency = ComponentFactory.createLabel()
      .label()
      .setLocator(this.page.getByText('web.offer.photovoltaics.offerType.selfSufficiency', { exact: true }).nth(0))
      .setVisible(true)
  ...
  async validateAllComponents(): Promise<void> {
    ...
    await this.monthlyConsumptionSufficiency.validateSelf()
